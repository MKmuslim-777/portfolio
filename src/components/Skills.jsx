...
const Skills = () => {
  ...
  const skills = [
    ...
    { name: 'JavaScript', icon: 'fab fa-js-square', color: '#F7DF1E', level: 88 },
          ...
          {[
            ...
            >
              <motion.div 
                ...
                className="text-3xl md:text-4xl font-bold text-primary font-display mb-2 group-hover:text-white transition-colors"
              >
                {stat.number}
              </motion.div>
